...
mkdir $voice_directory/voice_clunits
[ -d $voice_directory/voice_clunits ] && mv $voice_directory/voice_clunits $voice_directory/voice_clunits_old
cd $voice_directory && cp -r $voice_directory/voice $voice_directory/voice_clunits
